...
\begin{figure}
\includegraphics[width=0.99\textwidth,trim=0 200 0 175 cm]{multilinMESMA.pdf}
\caption{Abundanties van de verschillende waarden gebruik gemaakt van \textit{strict multilineair mesma}. Deze afbeelding is gemaakt met MATLAB\cite{matlab} \label{fig:mres}}
\end{figure}
